	...
	describe 'when user is invited' do
		...
		context 'user accepts invitation' do
			before do
				...
				open_email 'netjive8@aol.com'
				visit_in_email 'Accept invitation'

				fill_in 'Name', with: 'Ben Micol'
